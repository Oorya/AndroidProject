...
public class LoginGoogle extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
           ...
           /* user = new CalendarUser(acct.getEmail(),
                    acct.getDisplayName(),
                    acct.getId(),acct.getIdToken(),
            ...
            Intent eventDesply = new Intent(this,calendar.class);
            eventDesply.putExtra("userMail",user.getEmail());
            startActivity(eventDesply);
            finish();*/
